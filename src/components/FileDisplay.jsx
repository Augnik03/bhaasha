...
export default function FileDisplay(props) {
    ...
    return (
        <main className='flex-1  p-4 flex flex-col gap-3 text-center sm:gap-4 justify-center pb-20 w-full max-w-prose mx-auto'>
            <h1 className='font-semibold text-4xl sm:text-5xl md:text-6xl'><span className='text-red-500 bold'>Your</span> <span className='text-yellow-400 bold'>File</span></h1>
            ...
            <div className='flex items-center justify-between gap-4'>
                ...
                <button onClick={handleFormSubmission} className='specialBtn  px-3 p-2 rounded-3xl text-yellow-300 cursor-pointer hover:text-red-600 duration-200 flex items-center gap-2 font-medium '>
                    <p>Transcribe</p>
